    ...
    <div className="py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto px-4">
        <Link
          ...
          data-tooltip-content="All Pets"
          to={`/pets?category=Pets`}
        ...
        <Link
          data-tooltip-id="my-tooltip-inline"
          data-tooltip-content="All Accessories"
          to={`/pets?category=Accessories`}
          className="bg-white dark:bg-gray-800 border border-gray-400 shadow-md rounded-2xl p-6 text-center hover:shadow-lg hover:border-[#ff6d2d] hover:scale-105 transition-transform duration-300"
        >
          <div className="text-5xl mb-3">🎽</div>
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
        ...
        <Link
          data-tooltip-id="my-tooltip-inline"
          data-tooltip-content="All Care Products"
          to={`/pets?category=Care Products`}
          className="bg-white dark:bg-gray-800 border border-gray-400 shadow-md rounded-2xl p-6 text-center hover:shadow-lg hover:border-[#ff6d2d] hover:scale-105 transition-transform duration-300"
        >
          <div className="text-5xl mb-3">🧴</div>
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
        ...
        <Link
          data-tooltip-id="my-tooltip-inline"
          data-tooltip-content="All Pets Food"
          to={`/pets?category=Food`}
          className="bg-white dark:bg-gray-800 border border-gray-400 shadow-md rounded-2xl p-6 text-center hover:shadow-lg hover:border-[#ff6d2d] hover:scale-105 transition-transform duration-300"
        >
          <div className="text-5xl mb-3">🍖</div>
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
